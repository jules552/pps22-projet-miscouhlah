...
libmongoose.so: $(LIBMONGOOSEDIR)/mongoose.c $(LIBMONGOOSEDIR)/mongoose.h
...
clean::
	...
	cd $(LIBMONGOOSEDIR) && make mrproper
...
REPO := git@github.com:projprogsys-epfl/pps22-projet-miscouhlah.git
SSH_DIR := $(HOME)/.ssh
